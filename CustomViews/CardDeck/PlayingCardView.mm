...
- (void)drawRect:(CGRect)rect {
  ...
  if (self.faceUp) {
    NSString *imageName = [NSString stringWithFormat:@"%@%@", [self rankAsString], [self suiteAsAsciiChar]];
...
- (void)drawCorners
{
  ...
  [cornerText appendAttributedString:[[NSMutableAttributedString alloc]
                      initWithString:self.suit
                          attributes:@{ NSFontAttributeName : cornerFont,
                                        NSParagraphStyleAttributeName : paragraphStyle,
                                        NSForegroundColorAttributeName : [self colorForSuit]}]];
